...
def test_get_api_key_valid_user(email=valid_email, password=valid_password):
    '''Проверяем что код статуса запроса 200 и наличие, что в переменной result
...
def test_add_pets_with_valid_data(name='Jasmine', animal_type='cat', age='3', pet_photo='images/Jasmine.jpg'):
...
def test_delete_pet():
    ...
    if len(my_pets['pets']) == 0:
        pf.add_new_pets(api_key, 'Борис', 'cat', '5', 'images/Jasmine.jpg')
        _, my_pets = pf.get_list_of_pets(api_key, 'my_pets')
...
def test_add_pets_with_valid_data_without_photo(name='БорисБезФото', animal_type='кот', age='6'):
...
def test_add_photo_at_pet(pet_photo='images/Beggar.jpg'):
...
def test_add_pet_negative_age_number(name='Jasmine', animal_type='cat', age='-3', pet_photo='images/Jasmine.jpg'):
...
def test_add_pet_with_four_digit_age_number(name='Jasmine', animal_type='cat', age='1234', pet_photo='images/Jasmine.jpg'):
...
def test_add_pet_with_empty_value_in_variable_name(name='', animal_type='cat', age='2', pet_photo='images/Jasmine.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='cat', age='2', pet_photo='images/Jasmine.jpg'):
    ...
    name = 'Барнаби Мармадюк Алоизий Бенджи Кобвеб Дартаньян Эгберт Феликс Гаспар Гумберт'
...
def test_add_pet_with_special_characters_in_variable_animal_type(name='Jasmine', age='3', pet_photo='images/Jasmine.jpg'):
...
def test_add_pet_with_numbers_in_variable_animal_type(name='Jasmine', animal_type='34562', age='3', pet_photo='images/Jasmine.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_animal_type(name='Jasmine', age='2', pet_photo='images/Jasmine.jpg'):
    ...
    animal_type = 'Шитцу Кокер Спаниель Такса Вологодская Пушистая Египетская Лысая Норная Горная'
